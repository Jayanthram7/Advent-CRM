...
const LABEL_OPTIONS = ['Open', 'Call Back', 'Interested', 'Not Interested', 'Follow Up', 'Hot Call', 'Cold Call', 'Review', 'Completed', 'Closed'];
          ...
          {!submenu && (
            <>
              ...
              {!call.isConverted && isAdmin && (
                <div className="dropdown-item" onClick={convertCall}><CheckCircle size={14} />Mark as Completed</div>
              )}
...
function CallsPageContent() {
  ...
  useEffect(() => {
    if (isAdmin) {
      api.get('/calls', { params: { limit: '1', label: 'Review' } })
